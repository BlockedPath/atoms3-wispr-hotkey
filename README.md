...
```bash
g++ -std=c++17 -I./tests/stubs -I./include -I./src tests/test_button_gesture_tracker.cpp src/app/ButtonGestureTracker.cpp -o tests/test_button_gesture && ./tests/test_button_gesture
g++ -std=c++17 -I./src tests/test_battery_math.cpp -o tests/test_battery_math && ./tests/test_battery_math
```
